...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top" id="navbar" style="font-size: 17px; height: 110px; transition: top .5s">
    ...
    <a class="id"   >  <img src="images/ROYAUME DU MAURITANIEe.jpeg" class="logoMobile" id="" typeof="foaf:Image" alt="REPUBLIQUE ISLAMIQUE DE MAURITANIE" width="100" HEIGHT="90" align="right" > 
   <a href="https://www.FPT.ma/" class="navbar-brand" rel="home" title="">Ministére de la Fonction Publique et du Travail</a>  

   
   <!-- Logo site Ministére de la Fonction Publique et du Travail</a>  
 -->
  <!--
    <img src="R%C3%A9gion%20Souss%20Massa%20Terre%20d'excellence_fichiers/logo%2520crsm.png" alt="Accueil" id="logo">
       <img  src="R%C3%A9gion%20Souss%20Massa%20Terre%20d'excellence_fichiers/logoSticky.png" alt="FPT logo">  </a> -->

    <div class="logo" id="logo">
        <a class="navbar-brand " href="index.php" >
            <img src="images/logo-mauritanie.jpeg" title="Ministére de la Fonction Publique et du Travail" height="100" width="120" >
       </a>
    ...
    if (isset($_SESSION['id'])) {
      ...
      ';
       ...
       ';
        ...
        // Gestion du rôle service centrale
        else if ($_SESSION['username'] == 'service centrale') {
            echo '       
            <span class="open-slide">
                <span class="openS" onclick="openSlideMenu()">&#9776; </span>
            </span>
            <div id="side-menu" class="side-nav">
                <span class="btn-close" onclick="closeSlideMenu()">&times;</span>
                <span class="btn-outline-danger" style="color:white" href="#">User: Service centrale</span>
                <a class="" href="index.php" style="color: green"><i class="fa fa-envelope" aria-hidden="true"></i> Gestion des courriers</a>
                <a class="" href="reporting.php" style="color: blue"><i class="fa fa-chart-line" aria-hidden="true"></i> Reporting des courriers</a>
                <a class="" href="supervision.php" style="color: orange"><i class="fa fa-user-shield" aria-hidden="true"></i> Service centrale des agents</a>
            </div>
            <div class="ml-auto">
                <div>
                    <a class="" href="#"><img src="images\login.png" alt="Service centrale" class="avatar avatar-small circle" width="25" height="25"> Service centrale Bureau</a>
                </div>
                <div> 
                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#modaldecon">Déconnexion</button>
                </div>
            ...
            <div id="side-menu" class="side-nav">
                <span class="btn-close" onclick="closeSlideMenu()">&times;</span>
                <a href="consultation.php"><i class="fa fa-eye" aria-hidden="true"></i> Consultation des courriers</a>
            </div>';
        }
        else if ($role == 'directeur_service') {
            echo '
            <span class="open-slide">
                <span class="openS" onclick="openSlideMenu()">&#9776;</span>
            </span>
            <div id="side-menu" class="side-nav">
                <span class="btn-close" onclick="closeSlideMenu()">&times;</span>
                <a href="gestion_service.php"><i class="fa fa-users" aria-hidden="true"></i> Gestion du service</a>
            </div>';
        }
